...
// Plasmic Project: n66mgiyBB4oUW2nnpuYokY
// Component: IOZ8ETCDVVTu
...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IOZ8ETCDVVTu/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fPpp2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__i4Rdr)}
                role={"img"}
              />
            ),
